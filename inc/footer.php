						...
						<div class="row clearfix">
                            ...
                            <div class="footer-column col-lg-7 col-md-6 col-sm-12">
                                <div class="footer-widget logo-widget">
									...
									<div class="text">We are the best world Information Technology Company. Providing the highest quality in hardware & Network solutions. About more than 10 years of experience and 1000 of innovative achievements.</div>
									<!-- Social Box -->
									<ul class="social-box">
                            ...
                            <div class="footer-column col-lg-5 col-md-6 col-sm-12">
                                <div class="footer-widget links-widget">
									<h5>Quick Links</h5>
									<ul class="list-link">
										<li><a href="IT-BusinessServices.php">IT and Business Services</a></li>
                                        <li><a href="cloud-services.php">Cloud Services</a></li>
                                        <li><a href="cyber-security-services.php">Cyber Security Services</a></li>
										<li><a href="digital-consulting.php">Digital Consulting</a></li>
										<li><a href="machine-learning.php">Machine Learning & AI</a></li>
								...
								<div class="footer-widget contact-widget">
									...
									<ul>
										...
										<li>
											...
											<a href="mailto:info@globex.com">info@globaltechnocorp.com</a>
											<a href="mailto:hr@globex.com">hr@globaltechnocorp.com</a>
											<a href="mailto:sales@globex.com">sales@globaltechnocorp.com</a>
										</li>
									</ul>
								</div>
							</div>
				...
				<div class="auto-container">
					<div class="row clearfix">
						...
						<div class="column col-lg-6 col-md-12 col-sm-12">
							<div class="copyright">Copyright &copy; 2020 by Globaltechnocorp. All Rights Reserved.</div>
						</div>
						<!-- Column -->
						<div class="column col-lg-6 col-md-12 col-sm-12">
							<ul class="footer-nav">
