...
<head>
<meta charset="utf-8">
<title>Globaltechnocorp | Service</title>
		...
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="news-block-three col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="service-details.php"><img src="images/resource/news-5.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<div class="content">
								...
								<h4><a href="service-details.php">Web Development</a></h4>
								...
								<a class="read-more" href="service-details.php">Read More<span class="arrow flaticon-long-arrow-pointing-to-the-right"></span></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="news-block-three style-two col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						...
						<div class="image">
							<a href="service-details.php"><img src="images/resource/news-6.jpg" alt="" /></a>
						</div>
					</div>
				</div>
				...
				<div class="news-block-three col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="service-details.php"><img src="images/resource/news-7.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<div class="content">
								<div class="icon-box">
								...
								<h4><a href="service-details.php">UI/UX Design</a></h4>
				...
				<div class="news-block-three col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="service-details.php"><img src="images/resource/news-11.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<div class="content">
								<div class="icon-box">
								...
								<h4><a href="service-details.php">QA & Testing</a></h4>
				...
				<div class="news-block-three col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="service-details.php"><img src="images/resource/news-12.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<div class="content">
								<div class="icon-box">
								...
								<h4><a href="service-details.php">IT Consultancy</a></h4>
								<div class="text">Turn to our experts to perform comprehensive, multi-stage testing and auditing of your software.</div>
								<a class="read-more" href="service-details.php">Read More<span class="arrow flaticon-long-arrow-pointing-to-the-right"></span></a>
							</div>
						</div>
				...
				<div class="news-block-three col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="service-details.php"><img src="images/resource/news-13.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<div class="content">
								<div class="icon-box">
								...
								<h4><a href="service-details.php">Dedicated Team</a></h4>
			...
			<div class="row clearfix">
				...
				<div class="service-block col-lg-3 col-md-6 col-sm-12">
					<div class="inner-box">
						...
						<h5><a href="service-details.php">IT Soluations</a></h5>
						<div class="text">Sed ut perspiciatis unde omnis iste natus error volup validate your ideas.</div>
						<a href="service-details.php" class="arrow flaticon-long-arrow-pointing-to-the-right"></a>
					</div>
				</div>
				...
				<div class="service-block col-lg-3 col-md-6 col-sm-12">
					<div class="inner-box">
						...
						<h5><a href="service-details.php">Security System</a></h5>
						<div class="text">Sed ut perspiciatis unde omnis iste natus error volup validate your ideas.</div>
						<a href="service-details.php" class="arrow flaticon-long-arrow-pointing-to-the-right"></a>
					</div>
				</div>
				...
				<div class="service-block col-lg-3 col-md-6 col-sm-12">
					<div class="inner-box">
						...
						<h5><a href="service-details.php">Database Security</a></h5>
						<div class="text">Sed ut perspiciatis unde omnis iste natus error volup validate your ideas.</div>
						<a href="service-details.php" class="arrow flaticon-long-arrow-pointing-to-the-right"></a>
					</div>
				</div>
				...
				<div class="row clearfix">
					...
					<div class="service-block-two col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
							...
							<h5><a href="service-details.php">Web Develpment</a></h5>
							<div class="text">We carry more than just good coding skills. Our experience makes us stand out from other web development.</div>
						</div>
					</div>
					...
					<div class="service-block-two col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
							...
							<h5><a href="service-details.php">Mobile Development</a></h5>
					...
					<div class="service-block-two col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
							...
							<h5><a href="service-details.php">UI/UX Design</a></h5>
							<div class="text">Build the product you need on time with an experienced team that uses a clear and effective design process.</div>
						</div>
					</div>
					...
					<div class="service-block-two col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
							...
							<h5><a href="service-details.php">QA & Testing</a></h5>
							<div class="text">Turn to our experts to perform comprehensive, multi-stage testing and auditing of your software.</div>
						</div>
					</div>
					...
					<div class="service-block-two col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
							...
							<h5><a href="service-details.php">IT Counsultancy</a></h5>
					...
					<div class="service-block-two col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
							...
							<h5><a href="service-details.php">Dedicated Team</a></h5>
							<div class="text">Over the past decade, our customers succeeded by leveraging Intellectsoft’s process of building, motivating.</div>
						</div>
					</div>
